  ...
  delegate: function delegate(req, res, next, options){
    ...
    */    
    ...
    var images = [
      ...
      "assets/images/foreground/accessories/003-blue_accessory-03.png",
      "assets/images/foreground/mouth/006-blue_mouth-06.png",
      "assets/images/foreground/eyes/009-blue_eyes-04.png"
    ];
    ...
    _.when(stack).then(function(){
      ...
      images.forEach(function(image){
        stacked[image].copyResampled(output, dstX, dstY, srcX, srcY, dstW, dstH, 300, 300);
      })

      // write to disk
      output.savePng("temp.png", 0, function(err) {

      require('gm')("temp.png").toBuffer(function (err, buffer) {
...
/*var browser = window!==undefined;

function Robohash(string, options){
...
// features:
// - cache generated images -> localstorage -> base64 encoded
// - ...
...
var browser = {
  ...
  // ...
  url: function(){
    console.log("say browser!", "data url or remote?!");
  }

};

var delegate = function(ctx, fnc){
  return function(){
...
function Browser(){
  ...
  // Expose (External API)
  /*return {
    url: delegate(this, browser.url),
    download: delegate(this, browser.download),
    upload: delegate(this, browser.upload)
  };*/
/*};
...
function inherit(proto) {
  ...
  f.prototype.constructor = function simpson(){};
  f.prototype.constructor.name = "Jamie";
  return new f;
}

//Browser = inherit(function simon(){});

// ...
Browser.prototype = new Robohash();

// generate by canvas object
// download from server
// upload to server
Browser.prototype.download = function(){
...
// Server API
// features:
// - cache generated images -> s3, ..., / time to live, ...
// - ...
...
Webserver.prototype = inherit(Robohash);

// ...
var context =  window!==undefined ? new Browser() : new Webserver();
